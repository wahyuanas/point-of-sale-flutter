...
/// @nodoc
mixin _$OrderState {
  List<Item>? get orders => throw _privateConstructorUsedError;
...
class _$_OrderState with DiagnosticableTreeMixin implements _OrderState {
  const _$_OrderState({required final List<Item>? orders}) : _orders = orders;

  factory _$_OrderState.fromJson(Map<String, dynamic> json) =>
      _$$_OrderStateFromJson(json);

  final List<Item>? _orders;
  @override
  List<Item>? get orders {
    final value = _orders;
...
abstract class _OrderState implements OrderState {
  const factory _OrderState({required final List<Item>? orders}) =
      _$_OrderState;
