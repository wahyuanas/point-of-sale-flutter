...
class PosVehicleListSearchWidget extends StatefulWidget {
  const PosVehicleListSearchWidget({Key? key}) : super(key: key);

  @override
  State<PosVehicleListSearchWidget> createState() =>
      _PosVehicleListSearchWidgetState();
}

class _PosVehicleListSearchWidgetState
    extends State<PosVehicleListSearchWidget> {
    ...
    return Padding(
      ...
      child: Form(
        ...
        child: TextFormField(
          ...
          onChanged: ((value) {
            context.read<PosVehicleListCubit>().onSearchKeyChanged(value);
            if (value.isNotEmpty) {
            ...
            suffixIcon: _textFilled
                ? GestureDetector(
                    onTap: () {
                      ...
                      context.read<PosVehicleListCubit>().onReset();
                      setState(() {
                        _textFilled = false;
                      });
                    },
