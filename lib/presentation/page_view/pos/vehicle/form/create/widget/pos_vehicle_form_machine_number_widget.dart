...
class PosVehicleFormMachineNumberWidget extends StatefulWidget {
  ...
  @override
  State<PosVehicleFormMachineNumberWidget> createState() =>
      _PosVehicleFormMachineNumberWidgetState();
}

class _PosVehicleFormMachineNumberWidgetState
    extends State<PosVehicleFormMachineNumberWidget> {
  late bool _initial;
      ...
      child: BlocBuilder<VehicleFormCreateCubit, VehicleFormCreateState>(
        ...
        if (p.initial != c.initial) {
          ...
          c.status.maybeWhen(
              ...
              orElse: () => null);
          return false;
        } else if (p.createVehicle.machineNumber !=
            c.createVehicle.machineNumber) {
          if (_initial == true) _initial = false;
          return true;
        }
        return false;
          ...
          child: TextFormField(
              ...
              decoration: InputDecoration(
                errorText: _initial == false
                    ? state.createVehicle.machineNumber.value.fold(
                        (l) => l.maybeWhen(
              ...
              onChanged: (v) => BlocProvider.of<VehicleFormCreateCubit>(context)
                  .onCreateVehicleMachineNumberChanged(v)),
        );
      }),
    );
  }
