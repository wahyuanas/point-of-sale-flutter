...
class PosVehicleFormDescriptionWidget extends StatefulWidget {
  ...
  @override
  State<PosVehicleFormDescriptionWidget> createState() =>
      _PosVehicleFormDescriptionWidgetState();
}

class _PosVehicleFormDescriptionWidgetState
    extends State<PosVehicleFormDescriptionWidget> {
  late bool _initial;
      ...
      child: BlocBuilder<VehicleFormCreateCubit, VehicleFormCreateState>(
        ...
        if (p.initial != c.initial) {
          ...
          c.status.maybeWhen(
              ...
              orElse: () => null);
          return false;
        } else if (p.createVehicle.description != c.createVehicle.description) {
          if (_initial == true) _initial = false;
          return true;
        }
        return false;
          ...
          child: TextFormField(
              ...
              decoration: InputDecoration(
                errorText: _initial == false
                    ? state.createVehicle.description.value.fold(
                        (l) => l.maybeWhen(
              ...
              onChanged: (v) => BlocProvider.of<VehicleFormCreateCubit>(context)
                  .onCreateVehicleDescriptionChanged(v)),
        );
      }),
    );
  }
