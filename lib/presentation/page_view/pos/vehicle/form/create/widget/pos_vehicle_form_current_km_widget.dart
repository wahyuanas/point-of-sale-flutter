...
class PosVehicleFormCurrentKmWidget extends StatefulWidget {
  const PosVehicleFormCurrentKmWidget({Key? key}) : super(key: key);

  @override
  State<PosVehicleFormCurrentKmWidget> createState() =>
      _PosVehicleFormCurrentKmWidgetState();
}

class _PosVehicleFormCurrentKmWidgetState
    extends State<PosVehicleFormCurrentKmWidget> {
  late bool _initial;
      ...
      child: BlocBuilder<VehicleFormCreateCubit, VehicleFormCreateState>(
        ...
        if (p.initial != c.initial) {
          ...
          c.status.maybeWhen(
              ...
              orElse: () => null);
          return false;
        } else if (p.createVehicle.currentKm != c.createVehicle.currentKm) {
          if (_initial == true) _initial = false;
          return true;
        }
        return false;
        ...
        return Container(
          ...
          child: TextFormField(
              ...
              onChanged: (v) => BlocProvider.of<VehicleFormCreateCubit>(context)
                  .onCreateVehicleCurrentKmChanged(v)),
        );
      }),
    );
  }
