...
import 'pos_employee_department_form_export_widget.dart';

class PosEmployeeDepartmentFormWidget extends StatefulWidget {
  const PosEmployeeDepartmentFormWidget({Key? key}) : super(key: key);

  @override
  State<PosEmployeeDepartmentFormWidget> createState() =>
      _PosEmployeeDepartmentFormWidgetState();
}

class _PosEmployeeDepartmentFormWidgetState
    extends State<PosEmployeeDepartmentFormWidget> {
  @override
  Widget build(BuildContext context) {
    return BlocListener<EmployeeDepartmentFormCreateCubit,
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          //     ),
          //   ),
          //   onTap: () => const PosEmployeeDepartmentFormWidget(),
          // ),
          title: const Text(
        ...
        body: CustomScrollView(slivers: [
          const PosEmployeeDepartmentFormCodeWidget(),
          const PosEmployeeDepartmentFormNameWidget(),
