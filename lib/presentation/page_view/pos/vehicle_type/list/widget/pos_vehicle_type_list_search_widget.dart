...
class PosVehicleTypeListSearchWidget extends StatefulWidget {
  const PosVehicleTypeListSearchWidget({Key? key}) : super(key: key);

  @override
  State<PosVehicleTypeListSearchWidget> createState() =>
      _PosVehicleTypeListSearchWidgetState();
}

class _PosVehicleTypeListSearchWidgetState
    extends State<PosVehicleTypeListSearchWidget> {
    ...
    return Padding(
      ...
      child: Form(
        ...
        child: TextFormField(
          ...
          onChanged: ((value) {
            context.read<PosVehicleTypeListCubit>().onSearchKeyChanged(value);
            if (value.isNotEmpty) {
            ...
            suffixIcon: _textFilled
                ? GestureDetector(
                    onTap: () {
                      ...
                      context.read<PosVehicleTypeListCubit>().onReset();
                      setState(() {
                        _textFilled = false;
                      });
                    },
