...
class PosEmployeeListSearchWidget extends StatefulWidget {
  const PosEmployeeListSearchWidget({Key? key}) : super(key: key);

  @override
  State<PosEmployeeListSearchWidget> createState() =>
      _PosEmployeeListSearchWidgetState();
}

class _PosEmployeeListSearchWidgetState
    extends State<PosEmployeeListSearchWidget> {
    ...
    return Padding(
      ...
      child: Form(
        ...
        child: TextFormField(
          ...
          onChanged: ((value) {
            context.read<PosEmployeeListCubit>().onSearchKeyChanged(value);
            if (value.isNotEmpty) {
            ...
            suffixIcon: _textFilled
                ? GestureDetector(
                    onTap: () {
                      ...
                      context.read<PosEmployeeListCubit>().onReset();
                      setState(() {
                        _textFilled = false;
                      });
                    },
