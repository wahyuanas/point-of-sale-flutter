...
class PosPaymentItemTransactionCardWidget extends StatefulWidget {
  final Pos pos;
  const PosPaymentItemTransactionCardWidget({Key? key, required this.pos})
      : super(key: key);

  @override
  State<PosPaymentItemTransactionCardWidget> createState() =>
      _PosPaymentItemTransactionCardWidgetState();
}

class _PosPaymentItemTransactionCardWidgetState
    extends State<PosPaymentItemTransactionCardWidget> {
  @override
