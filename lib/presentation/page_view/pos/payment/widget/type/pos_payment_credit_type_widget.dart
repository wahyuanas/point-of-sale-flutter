...
class PosPaymentCreditTypeWidget extends StatefulWidget {
  const PosPaymentCreditTypeWidget({Key? key}) : super(key: key);

  @override
  State<PosPaymentCreditTypeWidget> createState() =>
      _PosPaymentCreditTypeWidgetState();
}

class _PosPaymentCreditTypeWidgetState
    extends State<PosPaymentCreditTypeWidget> {
  bool? _itsMe;
