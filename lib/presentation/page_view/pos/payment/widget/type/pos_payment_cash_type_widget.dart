...
class PosPaymentCashTypeWidget extends StatefulWidget {
  const PosPaymentCashTypeWidget({Key? key}) : super(key: key);

  @override
  State<PosPaymentCashTypeWidget> createState() =>
      _PosPaymentCashTypeWidgetState();
}

class _PosPaymentCashTypeWidgetState extends State<PosPaymentCashTypeWidget> {
  bool? _itsMe;
