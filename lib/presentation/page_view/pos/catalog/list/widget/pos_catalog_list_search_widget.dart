...
class PosCatalogListSearchWidget extends StatefulWidget {
  const PosCatalogListSearchWidget({Key? key}) : super(key: key);

  @override
  State<PosCatalogListSearchWidget> createState() =>
      _PosCatalogListSearchWidgetState();
}

class _PosCatalogListSearchWidgetState
    extends State<PosCatalogListSearchWidget> {
    ...
    return Padding(
      ...
      child: Form(
        ...
        child: TextFormField(
          ...
          onChanged: ((value) {
            context.read<PosCatalogListCubit>().onSearchKeyChanged(value);
            if (value.isNotEmpty) {
            ...
            suffixIcon: _textFilled
                ? GestureDetector(
                    onTap: () {
                      ...
                      context.read<PosCatalogListCubit>().onReset();
                      setState(() {
                        _textFilled = false;
                      });
                    },
