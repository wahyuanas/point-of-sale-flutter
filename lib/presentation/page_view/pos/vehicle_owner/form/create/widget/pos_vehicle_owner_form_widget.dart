...
class PosVehicleOwnerFormWidget extends StatefulWidget {
  const PosVehicleOwnerFormWidget({Key? key}) : super(key: key);

  @override
  State<PosVehicleOwnerFormWidget> createState() =>
      _PosVehicleOwnerFormWidgetState();
}
    ...
    return BlocListener<VehicleFormCreateCubit, VehicleFormCreateState>(
      ...
      child: Scaffold(
        ...
        body: CustomScrollView(slivers: [
          ...
          const PosVehicleOwnerFormNameWidget(),
