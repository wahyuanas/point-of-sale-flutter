...
class PosVehicleOwnerFormPhoneNumberWidget extends StatefulWidget {
  const PosVehicleOwnerFormPhoneNumberWidget({Key? key}) : super(key: key);

  @override
  State<PosVehicleOwnerFormPhoneNumberWidget> createState() =>
      _PosVehicleOwnerFormPhoneNumberWidgetState();
}

class _PosVehicleOwnerFormPhoneNumberWidgetState
    extends State<PosVehicleOwnerFormPhoneNumberWidget> {
  late bool _initial;
      ...
      child:
        ...
        if (p.initial != c.initial) {
          ...
          c.status.maybeWhen(
              ...
              orElse: () => null);
          return false;
        } else if (p.createVehicleOwner.phoneNumber !=
            c.createVehicleOwner.phoneNumber) {
          if (_initial == true) _initial = false;
          return true;
        }
        return false;
          ...
          child: TextFormField(
              ...
              onChanged: (v) =>
                  BlocProvider.of<VehicleOwnerFormCreateCubit>(context)
                      .onCreateVehicleOwnerPhoneNumberChanged(v)),
        );
      }),
    );
  }
